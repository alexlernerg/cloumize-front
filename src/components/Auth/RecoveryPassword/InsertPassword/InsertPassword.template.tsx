          ...
          <div>
            ...
            {props.touched.password && <div className='AuthContainer__form-error'>
              <p style={{color: (props.errors.password.lengthMsg === '' && props.errors.password.uppercaseMsg === '' && props.errors.password.lowercaseMsg === '') ? '#13D733' : '#FF434E'}}>Password must contain:</p>
                <ul>
                  {props.errors.password.lengthMsg === '' ? <li className='AuthContainer__form-error-correct'>v 8 characteres long</li>: <li>x At least 8 characteres</li>}
                  ...
                  {props.errors.password.lowercaseMsg === '' ? <li className='AuthContainer__form-error-correct'>v Lower case letter</li>: <li>x One lowercase letter</li>}
                </ul>
              </div>}
          </div>
          <div>
