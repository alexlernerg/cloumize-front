          ...
          >
            ...
            <button id="0" onClick={onClick}>
              {Number(ID) === 0 ? (
                ...
                <img
                  id="0"
                  src="/Landing/arrowDownLight.svg"
                  alt="No selected"
                />
              )}
            </button>
    ...
    <div className="LandingContainer">
      ...
      <section className="LandingContainer__Section1">
        ...
        <p className="LandingContainer__Section1-subtitle">
          ...
          more and those that work to charge less.{" "}
        ...
        <div className="LandingContainer__Section1-btns">
          <Link
            to={screenWidthMobile ? "/auth" : "/signup"}
            className="LandingContainer__Section1-btns-signup"
          >
            Sign up
          </Link>
          <a
      ...
      <section className="LandingContainer__Section2">
        ...
        <div className="LandingContainer__Section2-btns">
          <Link
            to={screenWidthMobile ? "/auth" : "/signup"}
            className="LandingContainer__Section2-btns-signup"
          >
            Sign up
          </Link>
          <a
      ...
      <section className="LandingContainer__Section5">
        ...
        {!screenWidthMobile && (
          <div className="LandingContainer__Section5-btns">
            <Link
              to={screenWidthMobile ? "/auth" : "/signup"}
              className="LandingContainer__Section5-btns-signup"
            >
              Sign up
            </Link>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="LandingContainer__Section5-btns-contact"
            >
              Contact Sales
            </a>
          </div>
        ...
        <div className="LandingContainer__Footer-part2">
          ...
          <div className="LandingContainer__Footer-part2__sm">
            <div>
              ...
              <a
                href="https://www.linkedin.com/company/cloumize/about/"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="https://twitter.com/Cloumize"
                target="_blank"
                rel="noreferrer"
              >
